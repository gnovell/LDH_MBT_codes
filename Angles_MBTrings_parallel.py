...
The code analyze the angles between planes of two MBT ring (C2-C4-C6) from MBT between the
neighbour MBT atoms of C2 atoms. The geometry is read from a Gromacs format file (*.gro)
