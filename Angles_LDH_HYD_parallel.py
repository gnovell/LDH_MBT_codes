...
The code analyze the angles between plane of AL-ZN2-ZN3 from LDH and the line of Oxygen and Hydrogen of hydroxil between the
neighbor atoms of Oxygen. The geometry is read from a Gromacs format file (*.gro)
...
def angulo_molecula(j):
    ...
    # Coordinates of atoms with minimal distances
...
frame_ini is the initial time of trajectory file extraction
